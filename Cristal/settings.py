"""
Django settings for Cristal project.
...
WSGI_APPLICATION = 'Cristal.wsgi.application'
...
# Directorios de archivos estáticos adicionales que se buscarán en desarrollo
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),
]

# El directorio donde Django recolectará todos los archivos estáticos en producción
